...
```groovy
implementation 'com.gitee.tiamosu:jfly-core:1.0.9'
```

### jfly-navigation（可选）

```groovy
implementation 'com.gitee.tiamosu:jfly-navigation:1.0.9'
```
...
```groovy
implementation 'com.gitee.tiamosu:jfly-viewbinding:1.0.9'
