...
open class NavHostFragment : Fragment(), NavHost {
    ...
    override val navController: NavController
        get() = checkNotNull(mNavController) { "NavController is not available before onCreate()" }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mNavController = NavHostController(context).apply {
    ...
    override fun onViewCreated(
        ...
        if (viewParent is View && viewParent.id == id) {
            Navigation.setViewNavController(viewParent, mNavController)
        }
    }
    ...
    companion object {
        ...
        fun findNavController(fragment: Fragment): NavController {
            ...
            error("Fragment $fragment does not have a NavController set")
        }
